...
from fairseq.modules.linformer_sentence_encoder import LinformerTransformerEncoder
...
class LinformerEncoder(FairseqEncoder):
    """RoBERTa encoder."""
...
@register_model_architecture("linformer_roberta", "linformer_roberta_imdb")
def linformer_roberta_imdb_architecture(args):
