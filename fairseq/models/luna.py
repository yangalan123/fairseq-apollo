...
@register_model_architecture('luna', 'luna_bart_large')
def luna_bart_large_architecture(args):
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', None)
...
@register_model_architecture('luna', 'luna_bart_base')
def luna_bart_base_architecture(args):
    ...
    luna_bart_large_architecture(args)
